...
A complete solution to the problem may be found [here](/js/advent_2022-01.js).  In the remainder of the article we provide a detailed explanation of the solution-code.
