...
The version of Plot porvided with Quarto often lags well behind the latest version as [documented](https://observablehq.com/plot/) by Observables.  In order to keep your Quarto project current with what works in your Observables notebooks, it is advisable to import the latest version of Plot, like this:
